define(['lib/key-mirror'], function(KeyMirror){
    ...
    return {
        ...
        Engine: {
            ...
            HOST: (window.document.location.host === 'www.tmhnix.com' || window.document.location.host === 'www.tmhnix.com') ? 'https://g2.tmhnix.com' : window.document.location.host.replace(/:3841$/, ':3842'),
