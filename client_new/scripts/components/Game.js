        ...
        render: function() {
            ...
            if(USER_MESSAGE && this.state.showMessage) {
                ...
                switch(USER_MESSAGE.type) {
                    ...
                    case 'newUser':
                        messageContent = D.span(null,
                            D.a({ href: "/request" }, "Welcome to tmhnix.com, to start you have 2 free bits, bits you can request them here or you can just watch the current games... have fun :D")
                        );
